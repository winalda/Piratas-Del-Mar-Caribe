...
-(NSArray*)tiles{
    ...
    [arraytile[6] setHistory:@"Has encontrado a un loro. No para de repetir 'Dos hay, uno huesos contiene, otro monedas de oro contiene. Encuentra el camino correcto'"];
    ...
    [arraytile[10] setHistory:@"oh no!!! Este tesoro es falso! Tiene un esqueleto dentro, pero ninguna moneda =("];
